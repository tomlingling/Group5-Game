...
public class PSDubois extends JPanel implements ActionListener
{
    GameOptions p1;
    JButton b1;
    JButton b2;
    ...
    public PSDubois(GameOptions games)
    {
        super();
        p1 = games;        
        ...
        b1 = new JButton();
        name = p1.playerName;        
        b1.setText("Welcome to Penn State DuBois " + name + ".");
        ...
        public void actionPerformed(ActionEvent event)
    {
        ...
        question.add(new History(p1,"PSDubois"));
        ...
        if (game=="Math"){
        JFrame question = new JFrame();
        question.add(new Math(p1, "PSDubois"));
        setBackground(Color.darkGray);        
        setLayout(null);    
        question.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        question.setSize(800, 640);        
        ...
        if (game=="Geography"){
        JFrame question = new JFrame();
        question.add(new Geography(p1, "PSDubois"));
        setBackground(Color.darkGray);        
        setLayout(null);    
        question.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        question.setSize(800, 640);        
